...
void CasoChar(node* root, long* array_explicito, int N, int d, int b, int tamaño, int tamaño_sample, long* gap_coded, long* sample){
    char* array_codificado = new char[tamaño-1];
    for(int i = 0; i < tamaño-1; i++){
        array_codificado[i] = CodeDiff(root, gap_coded[i+1]);
    }

   BusquedaBinariaChar(array_explicito, N, tamaño_sample, sample, d, tamaño, b, root, array_codificado, gap_coded);
}
...
void CasoShort(node* root, long* array_explicito, int N, int d, int b, int tamaño, int tamaño_sample, long* gap_coded, long* sample){
    short* array_codificado = new short[tamaño-1];
    for(int i = 0; i < tamaño-1; i++){
        array_codificado[i] = CodeDiff(root, gap_coded[i+1]);
    }
    BusquedaBinariaShort(array_explicito, N, tamaño_sample, sample, d, tamaño, b, root, array_codificado, gap_coded);
}
...
void CasoInt(node* root, long* array_explicito, int N, int d, int b, int tamaño, int tamaño_sample, long* gap_coded, long* sample){
    int* array_codificado = new int[tamaño-1];
    for(int i = 0; i < tamaño-1; i++){
        array_codificado[i] = CodeDiff(root, gap_coded[i+1]);
    }
    BusquedaBinariaInt(array_explicito, N, tamaño_sample, sample, d, tamaño, b, root, array_codificado, gap_coded);
}
...
void BusquedaBinariaChar(long* array_explicito, int N, int tamaño_sample, long* sample, int d, int tamaño, int b, node* root, char* array_codificado, long* gap_coded){
    ...
    for (int i = 0; i < N; i++) {
        ...
        if (file.is_open()) {
            file << d << "," << tamaño << "," << b << "," << root->height << "," << presente1 << "," << duration.count() << "," << entropia << ",1" << ",3" << endl;
            file.close();
        } 
        else {
